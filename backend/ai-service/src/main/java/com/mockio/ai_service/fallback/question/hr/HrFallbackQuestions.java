    ...
    public static Map<InterviewDifficulty, List<FallbackQuestion>> byDifficulty() {
        ...
        map.put(InterviewDifficulty.EASY, List.of(
                new FallbackQuestion(
                        "HR 역할",
                        "HR의 주요 역할은 무엇인가요?",
                        List.of("HR", "Role", "PeopleManagement")
                ),
                new FallbackQuestion(
                        "채용 프로세스",
                        "채용 프로세스의 기본 단계는 무엇인가요?",
                        List.of("Recruiting", "HiringProcess", "HR")
                ),
                new FallbackQuestion(
                        "온보딩 중요성",
                        "온보딩(Onboarding)이 중요한 이유는 무엇인가요?",
                        List.of("Onboarding", "Retention", "EmployeeExperience")
                ),
                new FallbackQuestion(
                        "평가 vs 피드백",
                        "평가(Evaluation)와 피드백(Feedback)의 차이는 무엇인가요?",
                        List.of("Evaluation", "Feedback", "Performance")
                ),
                new FallbackQuestion(
                        "조직 문화",
                        "조직 문화란 무엇인가요?",
                        List.of("Culture", "Organization", "Leadership")
                ),
                new FallbackQuestion(
                        "직무 기술서",
                        "직무 기술서(JD)는 왜 필요한가요?",
                        List.of("JD", "Recruiting", "RoleDefinition")
                ),
                new FallbackQuestion(
                        "인재상 정의",
                        "인재상은 왜 정의하나요?",
                        List.of("Talent", "CultureFit", "Recruiting")
                ),
                new FallbackQuestion(
                        "커뮤니케이션",
                        "구성원 커뮤니케이션에서 중요한 점은 무엇인가요?",
                        List.of("Communication", "Engagement", "HR")
                ),
                new FallbackQuestion(
                        "HR 데이터",
                        "HR 데이터는 어떤 것들이 있나요?",
                        List.of("HRAnalytics", "Data", "Metrics")
                ),
                new FallbackQuestion(
                        "공정성",
                        "공정성이 중요한 이유는 무엇인가요?",
                        List.of("Fairness", "Compliance", "Ethics")
                )
        ));
        ...
        map.put(InterviewDifficulty.MEDIUM, List.of(
                new FallbackQuestion(
                        ...
                        List.of("StructuredInterview", "Recruiting", "Evaluation")
                ),
                new FallbackQuestion(
                        "평가 제도 설계",
                        "평가 제도를 설계할 때 고려해야 할 요소는 무엇인가요?",
                        List.of("PerformanceReview", "Evaluation", "HRPolicy")
                ),
                new FallbackQuestion(
                        "성과 관리",
                        "성과 관리(Performance Management) 프로세스를 설명해 주세요.",
                        List.of("PerformanceManagement", "KPI", "Review")
                ),
                new FallbackQuestion(
                        "리텐션 전략",
                        "리텐션(이직 방지)을 개선하기 위한 접근은 무엇인가요?",
                        List.of("Retention", "Engagement", "HRStrategy")
                ),
                new FallbackQuestion(
                        "보상 설계",
                        "보상(Compensation)과 복리후생(Benefits) 설계의 핵심은 무엇인가요?",
                        List.of("Compensation", "Benefits", "Reward")
                ),
                new FallbackQuestion(
                        "조직 진단",
                        "조직 진단(engagement survey)을 어떻게 설계하고 활용하나요?",
                        List.of("Engagement", "Survey", "HRAnalytics")
                ),
                new FallbackQuestion(
                        "갈등 개입 원칙",
                        "갈등이 발생했을 때 HR의 개입 원칙은 무엇인가요?",
                        List.of("ConflictManagement", "Mediation", "HR")
                ),
                new FallbackQuestion(
                        "교육 효과 측정",
                        "교육/러닝 프로그램의 효과를 측정하는 방법은 무엇인가요?",
                        List.of("Learning", "Training", "ROI")
                ),
                new FallbackQuestion(
                        "핵심 인재 육성",
                        "핵심 인재(HiPo)를 정의하고 육성하는 방법은 무엇인가요?",
                        List.of("HiPo", "TalentDevelopment", "Leadership")
                ),
                new FallbackQuestion(
                        "법적/윤리적 인사 이슈",
                        "법적/윤리적 이슈가 있는 인사 사안을 처리할 때 주의점은 무엇인가요?",
                        List.of("Compliance", "LaborLaw", "Ethics")
                )
        ));
        ...
        map.put(InterviewDifficulty.HARD, List.of(
                new FallbackQuestion(
                        ...
                        List.of("Scaling", "HRProcess", "Growth")
                ),
                new FallbackQuestion(
                        "보상 체계 왜곡",
                        "평가/보상 체계가 조직 문화를 왜곡할 때 어떻게 개선하나요?",
                        List.of("Compensation", "Culture", "Incentive")
                ),
                new FallbackQuestion(
                        "조직 개편 전략",
                        "조직 개편(리오그) 시 리스크와 커뮤니케이션 전략은 무엇인가요?",
                        List.of("Reorg", "ChangeManagement", "Communication")
                ),
                new FallbackQuestion(
                        "리더십 모델",
                        "리더십 역량 모델을 만들고 적용하는 방법을 설명해 주세요.",
                        List.of("Leadership", "CompetencyModel", "HRStrategy")
                ),
                new FallbackQuestion(
                        "성과 개선 프로세스",
                        "성과가 낮은 팀/구성원에 대한 개선(Performance Improvement) 프로세스는 무엇인가요?",
                        List.of("PIP", "Performance", "HR")
                ),
                new FallbackQuestion(
                        "D&I 전략",
                        "다양성과 포용(D&I)을 실질 성과로 연결하는 방법은 무엇인가요?",
                        List.of("Diversity", "Inclusion", "Culture")
                ),
                new FallbackQuestion(
                        "채용 브랜딩",
                        "인재 확보 경쟁이 심한 시장에서 채용 브랜드를 강화하는 방법은 무엇인가요?",
                        List.of("EmployerBranding", "Recruiting", "Talent")
                ),
                new FallbackQuestion(
                        "노무 리스크 관리",
                        "노무/법적 리스크가 큰 사안에서 의사결정과 기록은 어떻게 관리하나요?",
                        List.of("LaborLaw", "RiskManagement", "Compliance")
                ),
                new FallbackQuestion(
                        "Employee Experience 개선",
                        "구성원 경험(Employee Experience)을 데이터로 개선하는 방법은 무엇인가요?",
                        List.of("EmployeeExperience", "HRAnalytics", "Engagement")
                ),
                new FallbackQuestion(
                        "신뢰 회복 전략",
                        "조직 신뢰가 깨진 상황에서 회복 전략을 어떻게 수립하나요?",
                        List.of("Trust", "Leadership", "Culture")
                )
        ));
