...
public enum CommonErrorEnum implements ErrorCode {
    ...
    ERR_REFRESH_TOKEN_MISSING(UNAUTHORIZED.value(),"ERR_TOKEN_EXPIRED","리프레시 토큰이 없습니다."),
    ERR_REFRESH_TOKEN_INVALID(UNAUTHORIZED.value(),"ERR_TOKEN_EXPIRED","리프레시 토큰이 일치하지 않습니다."),
