package com.mockio.core_service.ai.ollama.dto.request;

/**
 * Ollama Completions API 요청 바디를 표현하는 DTO.
 *
 * <p>모델 정보, 대화 메시지 목록, 생성 파라미터(temperature)를 포함하며
 * Ollama Chat Completion API 규격에 맞춰 직렬화된다.</p>
 */
...
public record OllamaChatRequest(
        @Schema(description = "사용할 ollama 모델", example = "ollama")
        String model,
