...
@Slf4j
public class OpenAICompareSummaryGenerator implements CompareSummaryGenerator {
     ...
     * </ol>
     *
     * @param command 면접 비교 요약을 위한 입력 정보
     * @return 면접 비교 요약
     */
    @Override
    @CircuitBreaker(name = "openaiCompareSummaryChat")
