package com.mockio.core_service.feedback.kafka.domain;
...
@Entity
@Table(name = "outbox_feedback_events")
@Getter
@NoArgsConstructor(access = PROTECTED)
public class OutboxFeedbackEvent extends BaseTimeEntity {
    ...
    public static OutboxFeedbackEvent createNew(UUID eventId,
                                          Long userId,
                                          String eventType,
                                          JsonNode payloadJson) {
        return OutboxFeedbackEvent.builder()
                .eventId(eventId)
                .aggregateType("USER")
                .aggregateId(userId)
                .eventType(eventType)
    ...
    public static OutboxFeedbackEvent pending(UUID eventId,
                                          Long userId,
                                          String eventType,
                                          JsonNode payloadJson) {
        return OutboxFeedbackEvent.builder()
