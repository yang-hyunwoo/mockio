...
public class InterviewMapper {
    ...
    public static InterviewScoreHistoryResponse.Item fromScoreHistory(
        ...
        InterviewScoreListResponse.Item item = scoreMap.get(interview.getId());
    ...
    public static WeakPointResponse fromWeakPoint(List<InterviewScoreListResponse.Item> items) {
        ...
        int structureAvg = (int) Math.round(
                items.stream()
                        .mapToInt(InterviewScoreListResponse.Item::structure)
                        .average()
                        .orElse(0)
        );
        ...
        int clarityAvg = (int) Math.round(
                items.stream()
                        .mapToInt(InterviewScoreListResponse.Item::clarity)
                        .average()
                        .orElse(0)
        );
        ...
        int specificityAvg = (int) Math.round(
                items.stream()
                        .mapToInt(InterviewScoreListResponse.Item::specificity)
                        .average()
                        .orElse(0)
        );
