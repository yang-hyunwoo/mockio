...
import com.mockio.support_service.properties.CoreServiceClientProperties;
...
@EnableConfigurationProperties({
        CoreServiceClientProperties.class
})
public class RestClientConfig {

    private final String internalToken;

    public RestClientConfig(@Value("${internal.support.token}") String internalToken) {
        this.internalToken = internalToken;
    }

    @Bean
    public RestClient coreServiceRestClient(
